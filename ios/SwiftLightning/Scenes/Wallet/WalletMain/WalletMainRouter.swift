...
class WalletMainRouter: NSObject, WalletMainRoutingLogic, WalletMainDataPassing
{
  ...
  //func navigateToSomewhere(source: WalletMainViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: WalletMainDataStore, destination: inout SomewhereDataStore)
  //{
